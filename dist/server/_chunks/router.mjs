...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, {
    client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, {
      mode: "wait", initial: false, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          variants,
          initial: "initial",
...
function Nav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "mx-auto max-w-7xl px-6 py-4 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, {
          to: "/", className: "flex items-center gap-3 group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            ...
            className: "font-mono text-[10px] tracking-[0.25em] uppercase text-bone/80 leading-tight hidden sm:block", children: [
              "Syndicated",
          ...
          className: "hidden lg:flex items-center gap-8", children: NAV.map((n) => {
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "lg:hidden glass border-t border-white/5 px-6 py-6 flex flex-col gap-4", children: [
            NAV.map((n) => {
              const href = n.hash ? `/#${n.hash}` : n.to;
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", {
    className: "relative border-t border-white/10 bg-carbon overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 noise-bg opacity-60 pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
      className: "relative overflow-hidden py-6 border-b border-white/5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "flex whitespace-nowrap scroll-marquee", children: Array.from({ length: 2 }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "flex items-center gap-12 px-6 font-display text-4xl md:text-6xl text-bone/10", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "relative mx-auto max-w-7xl px-6 py-16 grid lg:grid-cols-4 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "flex flex-col gap-3 text-sm text-bone/70", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
      className: "relative border-t border-white/5 py-6 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "mx-auto max-w-7xl flex flex-col md:flex-row justify-between gap-3 text-bone/40 text-[11px] font-mono uppercase tracking-[0.25em]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          children: [
            "© ",
...
function PageHero({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", {
    className: "relative pt-40 pb-28 px-6 overflow-hidden grain border-b border-white/10", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "relative mx-auto max-w-7xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "inline-flex items-center gap-2 glass-acid rounded-full px-4 py-1.5 mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: "mt-12 flex items-center gap-4 font-mono text-[10px] uppercase tracking-[0.3em] text-bone/40", children: [
...
function BuildGallery() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", {
    id: "gallery", className: "relative py-32 px-6 bg-carbon border-y border-white/10 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 noise-bg pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "relative mx-auto max-w-7xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "reveal mb-12", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", {
          className: "font-display text-4xl md:text-6xl leading-[1] max-w-4xl text-gradient-bone", children: [
            "Watch every ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "reveal mb-10 flex flex-wrap gap-2", children: FILTERS.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: () => {
              setFilter(f);
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 auto-rows-[180px] md:auto-rows-[220px] gap-3", children: filtered.map((m, i) => {
          const isBig = i === 0 || i % 7 === 0;
          return /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
            className: `reveal ${isBig ? "col-span-2 row-span-2" : ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                    className: "absolute bottom-0 left-0 right-0 p-4", children: [
        ...
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                className: "lg:col-span-7 relative bg-ink/50 flex items-center justify-center h-[40vh] sm:h-[50vh] lg:h-[75vh] border-b lg:border-b-0 lg:border-r border-white/10 group/img", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                className: "lg:col-span-5 p-8 flex flex-col justify-between overflow-y-auto max-h-[45vh] lg:max-h-[75vh]", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-bone/70 text-sm md:text-base leading-relaxed font-sans", children: active.longDesc || active.caption }),
                    active.details && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                      className: "border-t border-white/10 pt-6 space-y-4", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("dl", {
                        className: "grid sm:grid-cols-2 gap-4", children: active.details.map((d, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "div",
                          {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                  className: "mt-8 pt-6 border-t border-white/10 flex items-center justify-between text-bone/40 font-mono text-[10px] uppercase tracking-[0.25em]", children: [
...
function TheBuildPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", {
    className: "bg-ink text-bone overflow-x-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Nav, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      PageHero,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
      className: "py-32 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "mx-auto max-w-7xl space-y-32", children: phases.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "article",
          {
            className: `reveal grid lg:grid-cols-12 gap-12 items-center ${i % 2 ? "lg:[&>*:first-child]:order-2" : ""}`,
            children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
              className: "lg:col-span-7", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                className: "overflow-hidden border border-white/10 group", children: p.img ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                    src: p.img,
                    alt: p.t,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              className: "lg:col-span-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                className: "font-mono text-xs tracking-[0.3em] uppercase text-acid mb-3", children: [
                  "Phase ",
                  p.n
                ]
              }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", {
                className: "space-y-2 border-t border-white/10 pt-6 mb-6", children: p.bullets.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", {
                  className: "flex gap-3 text-bone/80", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                className: "font-mono text-xs uppercase tracking-[0.25em] text-bone/50", children: [
                  "Partner: ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
      className: "py-32 px-6 bg-carbon border-y border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", {
          className: "reveal font-display text-4xl md:text-5xl leading-[1] mb-16", children: [
            "Technical ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-acid", children: "Snapshot." })
          ]
        }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("dl", {
          className: "grid md:grid-cols-2 gap-px bg-white/10 border border-white/10", children: specs.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: "reveal bg-carbon p-8 hover:bg-steel transition-colors", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
      className: "py-32 px-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "mx-auto max-w-3xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", {
          className: "reveal font-display text-4xl md:text-6xl leading-[1] mb-10", children: [
            "Watch it ",
...
function EventsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    className: "min-h-screen bg-ink text-bone", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Nav, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      PageHero,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
      className: "py-24 px-6 border-b border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "mx-auto max-w-7xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "reveal flex flex-col md:flex-row md:items-end md:justify-between mb-16 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
          className: "space-y-6", children: events.map((ev, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
            className: "reveal", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                  className: "md:w-32 shrink-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-xs text-acid uppercase tracking-widest", children: ev.date }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                    className: "mt-1 inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-white/5 border border-white/10", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                  className: "md:w-48 shrink-0 md:text-right flex flex-col md:items-end justify-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, {
      children: selectedEventIdx !== null && currentEvent && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0 },
          animate: { opacity: 1 },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                className: "md:col-span-5 p-8 bg-ink/40 border-b md:border-b-0 md:border-r border-white/10 flex flex-col justify-between max-h-[40vh] md:max-h-[85vh] overflow-y-auto", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                  className: "space-y-6", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                    children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                    className: "space-y-4 border-t border-white/10 pt-6", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                      ...
                      currentEvent.capacity && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                        className: "flex items-start gap-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                className: "md:col-span-7 p-8 flex flex-col justify-between max-h-[50vh] md:max-h-[85vh] overflow-y-auto", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                  className: "space-y-8", children: [
                    ...
                    currentEvent.schedule && currentEvent.schedule.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                      children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("ol", {
                        className: "relative border-l border-white/10 ml-2 space-y-4", children: currentEvent.schedule.map((item, idx) => {
                    ...
                    currentEvent.requirements && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                      className: "bg-ink/30 border border-white/5 p-4 flex gap-3 items-start", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                  className: "mt-8 pt-6 border-t border-white/10 flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Link,
                    {
                      to: "/apply",
                      onClick: () => setSelectedEventIdx(null),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
      className: "py-24 px-6 grain relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "mx-auto max-w-4xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "reveal text-center mb-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
          className: "space-y-4", children: faqs.map((faq, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
            className: "reveal", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
      className: "py-24 px-6 text-center border-t border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "reveal mx-auto max-w-3xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", {
          className: "font-display text-4xl md:text-6xl leading-[0.95] mb-6", children: [
            "Still Have ",
...
function GalleryPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
      className: "py-24 px-6 bg-carbon", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "mx-auto max-w-7xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
          className: "grid md:grid-cols-4 grid-cols-2 auto-rows-[16rem] gap-4", children: items.map((it, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
            className: `reveal ${it.span ?? ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "figure",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("figcaption", {
                    className: "absolute bottom-0 left-0 right-0 p-5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, {
      children: selectedIdx !== null && currentItem && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0 },
          animate: { opacity: 1 },
              ...
              children: [
                ...
                className: "lg:col-span-5 p-8 flex flex-col justify-between overflow-y-auto max-h-[45vh] lg:max-h-[75vh]", children: [
                  ...
                  className: "space-y-6", children: [
                    ...
                    currentItem.details && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                      className: "border-t border-white/10 pt-6 space-y-4", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-mono text-[10px] uppercase tracking-[0.25em] text-acid", children: "Specifications & Details" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("dl", {
                        className: "grid sm:grid-cols-2 gap-4", children: currentItem.details.map((d, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "div",
                          {
                            className: "bg-ink/30 border border-white/5 p-4 hover:border-white/10 transition-colors",
                            children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
      className: "py-32 px-6 text-center border-t border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "mx-auto max-w-3xl", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "flex flex-col sm:flex-row gap-4 justify-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: "/the-build",
...
function ContactPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
      className: "py-24 px-6 border-b border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "mx-auto max-w-7xl grid md:grid-cols-2 gap-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
            className: "space-y-8", children: directLines.map((line, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: "mt-12 pt-8 border-t border-white/10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", {
              className: "text-bone/70 leading-relaxed", children: workshopAddress.map((line, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", {
                children: [
                  line,
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {})
                ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "reveal bg-carbon border border-white/10 rounded-lg p-8 md:p-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl mb-8", children: "Write To Us" }),
            sent ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
      className: "py-24 px-6 grain relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "mx-auto max-w-7xl text-center reveal", children: [
...
function ApplyPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", {
    className: "bg-ink text-bone overflow-x-hidden min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Nav, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      PageHero,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
      className: "py-24 px-6 bg-carbon border-b border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "mx-auto max-w-7xl", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
          className: "grid md:grid-cols-4 gap-px bg-white/10 border border-white/10", children: steps.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: "reveal bg-carbon p-8 hover:bg-steel transition-colors", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
      className: "py-32 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "mx-auto max-w-3xl", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", {
          className: "reveal font-display text-4xl md:text-5xl leading-[1] mb-12", children: [
            "Register Your ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-acid", children: "Interest." })
          ]
        }),
          submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: "reveal border border-acid bg-acid/5 p-10 text-center", children: [
...
function Field({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("label", {
      className: "block font-mono text-xs tracking-[0.3em] uppercase text-bone/60 mb-2", children: [
        label,
        " ",
...
function AboutPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
      className: "py-24 px-6 border-b border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "mx-auto max-w-7xl grid md:grid-cols-2 gap-16 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "reveal", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", {
            className: "font-display text-4xl md:text-5xl leading-[1.05] mb-6", children: [
              "Reimagine What A",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              "Restomod Can Be"
            ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
          className: "reveal", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: aboutDetail,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
      className: "py-24 px-6 grain relative border-b border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "mx-auto max-w-7xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "reveal text-center mb-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
          className: "grid md:grid-cols-3 gap-8", children: principles.map((v) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: "reveal bg-carbon border border-white/10 rounded-lg p-8 hover:border-acid/30 transition-colors duration-500", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
          className: "grid md:grid-cols-4 gap-6", children: architects.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: "reveal bg-carbon border border-white/10 rounded-lg p-6 text-center hover:border-acid/30 transition-colors duration-500", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
      className: "py-24 px-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "reveal mx-auto max-w-3xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", {
          className: "font-display text-4xl md:text-6xl leading-[0.95] mb-6", children: [
            "Want To Join ",
...
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", {
    id: "top", className: "relative min-h-screen w-full overflow-hidden grain flex items-center justify-center py-24 md:pt-28 md:pb-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "video",
      {
        src: heroVideo,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "relative z-10 w-full flex flex-col items-center justify-center text-center px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "inline-flex items-center gap-2 glass-acid rounded-full px-5 py-2 mb-8 animate-in fade-in slide-in-from-bottom duration-1000", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-acid animate-pulse" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", {
        className: "font-display text-6xl md:text-8xl lg:text-9xl leading-[0.9] max-w-6xl animate-in fade-in slide-in-from-bottom duration-1000 delay-100", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "mt-10 flex flex-col sm:flex-row gap-4 animate-in fade-in slide-in-from-bottom duration-1000 delay-300", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "mt-16 grid grid-cols-3 gap-8 max-w-2xl animate-in fade-in duration-1000 delay-500", children: [
          { k: "Car", v: "#148 / 500" },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "absolute bottom-8 left-1/2 -translate-x-1/2 z-10 flex items-center gap-3 font-mono text-[10px] text-bone/40 tracking-[0.3em] uppercase", children: [
...
function SectionLabel({ kicker, title }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    className: "reveal mb-16", children: [
...
function Intro() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
    id: "intro", className: "relative py-32 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "mx-auto max-w-6xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, {
        kicker: "● Not Just Ownership", title: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
          children: [
            "Not Just Ownership.",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "grid md:grid-cols-2 gap-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "reveal space-y-6 text-bone/70 text-lg leading-relaxed", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "reveal space-y-6 text-bone/60 leading-relaxed", children: [
...
function Stats() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", {
    className: "relative py-24 px-6 border-y border-white/5 bg-carbon/50 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 noise-bg pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
      className: "relative mx-auto max-w-7xl mb-12 text-center reveal", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", {
        className: "font-mono text-xs md:text-sm tracking-[0.3em] uppercase text-bone/60", children: [
          "Powered By ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
      className: "relative mx-auto max-w-7xl grid grid-cols-2 md:grid-cols-5 gap-px bg-white/5", children: [
      ...
      ].map((st) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "reveal text-center py-6 px-2 bg-ink/60 hover:bg-ink transition-colors group flex flex-col justify-center items-center", children: [
...
function Pillars({ pillars }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", {
    className: "relative py-32 px-6 bg-carbon overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 noise-bg pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "mx-auto max-w-7xl", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "reveal-stagger grid md:grid-cols-3 gap-8", children: pillars.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", {
          className: "group rounded-2xl border border-white/10 bg-ink overflow-hidden hover-lift", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: "aspect-[4/5] overflow-hidden relative", children: [
              p.video ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "video",
                {
                  src: p.video,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                className: "absolute top-4 left-4 glass-acid rounded-full px-3 py-1 font-mono text-[10px] tracking-[0.3em] text-bone", children: [
                  "PILLAR ",
                  p.n
                ]
              })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: "p-8 -mt-16 relative", children: [
...
function TheCar() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
    id: "car", className: "relative py-32 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "mx-auto max-w-7xl grid lg:grid-cols-12 gap-12 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "lg:col-span-7 reveal", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "relative overflow-hidden border border-white/10 aspect-video", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
            "video",
            {
              src: videoCarSection,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", {
          className: "space-y-3 border-t border-white/10 pt-6", children: [
            "One-of-one build",
            "Engineering-led, not cosmetic",
            "Heritage-informed design",
            "Built for road and track"
          ].map((h, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", {
            className: "flex gap-4 items-baseline", children: [
...
function LiveSyndicates({ syndicates }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
    id: "syndicates", className: "relative py-32 px-6 bg-carbon", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "mx-auto max-w-7xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
        SectionLabel,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "reveal-stagger grid md:grid-cols-3 gap-8", children: syndicates.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", {
          className: `group border ${s.isPlaceholder ? "border-white/5" : "border-white/10 hover:border-acid"} bg-ink overflow-hidden transition-all duration-300 flex flex-col justify-between`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: "aspect-[16/10] overflow-hidden relative bg-carbon", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: s.img,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: "p-8 flex-1 flex flex-col justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", {
                className: "space-y-2 text-bone/60 text-sm border-t border-white/5 pt-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
              className: "mt-8", children: s.waitlist ? /* @__PURE__ */ jsxRuntimeExports.jsxs("form", {
                className: "flex flex-col gap-2", onSubmit: (e) => e.preventDefault(), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    type: "email",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "mt-20 reveal border border-white/10 bg-ink p-8 md:p-12 flex flex-col lg:flex-row items-center justify-between gap-10 relative overflow-hidden group", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "relative z-10 lg:max-w-xl text-center lg:text-left", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
          className: "relative z-10 w-full lg:w-auto flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", {
            className: "flex flex-col sm:flex-row gap-3 w-full max-w-lg mx-auto lg:mx-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "email",
...
function Partnership({ steps }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
    className: "relative py-32 px-6 bg-carbon", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "mx-auto max-w-7xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
        SectionLabel,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "mt-12 reveal flex items-center gap-6 justify-center text-bone/50 text-sm", children: [
...
function BuildProcess({ process: process2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", {
    id: "build", className: "relative py-32 px-6 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "video",
      {
        src: videoCarSection,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "relative mx-auto max-w-7xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, {
        kicker: "The Build Process", title: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
          children: [
            "Engineered ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-acid", children: "in the open." })
          ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "reveal-stagger grid md:grid-cols-2 lg:grid-cols-4 gap-8", children: process2.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "border-t-2 border-acid pt-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: "font-mono text-xs tracking-[0.3em] uppercase text-acid mb-2", children: [
              "Phase ",
              p.n
            ]
          }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", {
            className: "space-y-2 text-bone/70 text-sm", children: p.items.map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", {
...
function Events({ events }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
    id: "events", className: "relative py-32 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "mx-auto max-w-7xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
        SectionLabel,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "grid md:grid-cols-3 gap-8", children: events.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "reveal border border-white/10 bg-carbon p-8 flex flex-col justify-between hover:border-acid transition-all duration-300", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              className: "flex justify-between items-start mb-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
            className: "mt-8 pt-6 border-t border-white/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: "#apply",
...
function Partners({ partners }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
    id: "partners", className: "relative py-32 px-6 bg-carbon", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "mx-auto max-w-7xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, {
        kicker: "Partners", title: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
          children: [
            "Built with ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "grid grid-cols-2 md:grid-cols-4 gap-px bg-white/10 border border-white/10", children: partners.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "reveal bg-carbon p-8 hover:bg-steel transition-colors", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: "font-mono text-xs tracking-[0.3em] uppercase text-acid mb-4", children: [
              "Partner ",
...
function Benefits({ benefits }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
    className: "relative py-32 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "mx-auto max-w-7xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, {
        kicker: "Syndicate Benefits", title: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
          children: [
            "More than an ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className: "grid md:grid-cols-4 gap-6", children: benefits.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "reveal border border-white/10 p-8 hover:border-acid transition-colors", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", {
            className: "space-y-2 text-bone/60 text-sm", children: b.items.map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", {
              children: [
                "— ",
                i
              ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", {
        className: "reveal text-center mt-16 font-display text-2xl md:text-3xl text-bone/80", children: [
          "This is ownership ",
...
function Value() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", {
    className: "relative py-32 px-6 overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", {
        className: "reveal font-display text-4xl md:text-6xl leading-[1] mb-10 max-w-3xl", children: [
          "A Different Kind of ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        ...
        ].map((v) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className: "reveal bg-ink/60 backdrop-blur border border-white/10 p-6", children: [
...
function Apply() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", {
    id: "apply", className: "relative py-40 px-6 border-t border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "mx-auto max-w-5xl text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", {
        className: "reveal font-display text-5xl md:text-7xl leading-[0.95] mb-10", children: [
          "Limited ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-acid", children: "Allocation." })
        ]
      }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", {
        className: "reveal text-bone/70 space-y-2 mb-12 inline-block text-left", children: [
