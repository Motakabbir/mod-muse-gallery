...
import { R as Route$6 } from "./router-DREP7IlL.mjs";
...
const buildFinish = "/assets/gallery-2-BNSHI9Rh.jpg";
const buildProcess = "/assets/gallery-2-BNSHI9Rh.jpg";
const gallery2 = "/assets/gallery-2-BNSHI9Rh.jpg";
const gallery3 = "/assets/gallery-2-BNSHI9Rh.jpg";
const gallery4 = "/assets/gallery-2-BNSHI9Rh.jpg";
const MEDIA = [
  {
    kind: "video",
...
function TheBuildPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "bg-ink text-bone overflow-x-hidden", children: [
    ...
    ] }), subtitle: "Every stage documented. Every decision visible. From bare shell to first ignition, syndicate members travel with the build from day one.", video: heroVideo, videoClassName: "opacity-60", overlayClassName: "bg-gradient-to-b from-ink/30 via-ink/50 to-ink" }),
