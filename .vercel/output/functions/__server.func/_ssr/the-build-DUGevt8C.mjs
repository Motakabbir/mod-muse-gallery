...
import { u as useReveal, N as Nav, P as PageHero, F as Footer } from "./site-CF3RPQSj.mjs";
import { c as carbonTexture } from "./carbon-texture-CrF_2aOK.mjs";
import { h as heroVideo$1 } from "./Hero_002-BDf_P1XZ.mjs";
import { R as Route$6 } from "./router-SySZ-HTb.mjs";
...
function TheBuildPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "bg-ink text-bone overflow-x-hidden", children: [
    ...
    ] }), subtitle: "Every stage documented. Every decision visible. From bare shell to first ignition, syndicate members travel with the build from day one.", video: heroVideo$1, videoClassName: "opacity-60", overlayClassName: "bg-gradient-to-b from-ink/30 via-ink/50 to-ink" }),
