...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CU6LVAOA.mjs");
...
const manifest = {
  ...
  "99b07c72264bd83f294bf8c190daadda04dd85ad1509ca79cec14ab8c32bf477": {
    ...
    importer: () => import("./build-Catos2wX.mjs")
  },
  ...
  "b6ec13c45afd3f3a4fc06cbfb77f797107faeaad290a546d85fda1f90d7de29b": {
    ...
    importer: () => import("./about-Cs0ujCaX.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-aV8EaM4S.mjs").then((n) => n.r),
    import("./start-BLwrBjJC.mjs"),
