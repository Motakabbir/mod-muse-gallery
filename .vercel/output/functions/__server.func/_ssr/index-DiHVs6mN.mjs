...
import { h as heroVideo } from "./video-cI6Pl01s.mjs";
import { L as Link } from "../_libs/tanstack__react-router.mjs";
import { u as useReveal, N as Nav, F as Footer } from "./site-paN77MRt.mjs";
import { f as Route } from "./router-D203jVjn.mjs";
...
const videoCarSection = "/assets/RS500_REIMAGINED_MORPHING-Dd6Plgc9.mp4";
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "top", className: "relative min-h-screen w-full overflow-hidden grain flex items-center justify-center py-24 md:pt-28 md:pb-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("video", { src: heroVideo, autoPlay: true, muted: true, loop: true, playsInline: true, className: "absolute inset-0 h-full w-full object-cover" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-1/4 -right-20 h-96 w-96 rounded-full bg-acid/10 blur-[140px] float-slow", style: {
      animationDelay: "2s"
    } }),
...
function Stats() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative py-24 px-6 border-y border-white/5 bg-carbon/50 overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mx-auto max-w-7xl grid grid-cols-2 md:grid-cols-5 gap-px bg-white/5", children: [{
      ...
      n: "12.6",
      label: "ANNUAL RATE OF RETURN SINCE 2021"
    }, {
      n: "2020",
      label: "FIRST CAR LAUNCHED"
    }, {
      n: "60",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal-stagger grid md:grid-cols-3 gap-8", children: pillars.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "group rounded-2xl border border-white/10 bg-ink overflow-hidden hover-lift", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aspect-[4/5] overflow-hidden relative", children: [
          p.video ? /* @__PURE__ */ jsxRuntimeExports.jsx("video", { src: p.video, autoPlay: true, muted: true, loop: true, playsInline: true, className: "h-full w-full object-cover group-hover:scale-110 transition-transform duration-1000" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: p.img, alt: p.title, loading: "lazy", className: "h-full w-full object-cover group-hover:scale-110 transition-transform duration-1000" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-ink via-ink/20 to-transparent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-4 left-4 glass-acid rounded-full px-3 py-1 font-mono text-[10px] tracking-[0.3em] text-acid", children: [
            "PILLAR ",
            p.n
          ] })
        ] }),
...
function TheCar() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "car", className: "relative py-32 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl grid lg:grid-cols-12 gap-12 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-7 reveal", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden border border-white/10 aspect-video", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("video", { src: videoCarSection, autoPlay: true, muted: true, loop: true, playsInline: true, className: "w-full h-full object-cover hover:scale-102 transition-transform duration-700" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-5 reveal", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3 border-t border-white/10 pt-6", children: ["One-of-one build", "Engineering-led, not cosmetic", "Heritage-informed design", "Built for road and track"].map((h, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-4 items-baseline", children: [
...
function LiveSyndicates({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "syndicates", className: "relative py-32 px-6 bg-carbon", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { kicker: "Active Opportunities", title: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      "Live Syndicates. ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal-stagger grid md:grid-cols-3 gap-8", children: syndicates.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: `group border ${s.isPlaceholder ? "border-white/5" : "border-white/10 hover:border-acid"} bg-ink overflow-hidden transition-all duration-300 flex flex-col justify-between`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aspect-[16/10] overflow-hidden relative bg-carbon", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: s.img, alt: s.title, loading: "lazy", className: `h-full w-full object-cover transition-transform duration-700 ${s.isPlaceholder ? "blur-md opacity-30 grayscale scale-110" : "group-hover:scale-105"}` }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8 flex-1 flex flex-col justify-between", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8", children: s.waitlist ? /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "flex flex-col gap-2", onSubmit: (e) => e.preventDefault(), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "email", placeholder: "Email for waitlist", required: true, className: "bg-carbon border border-white/10 px-4 py-3 rounded-full text-bone placeholder:text-bone/40 focus:outline-none focus:border-acid w-full transition-colors text-xs text-center" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", className: "w-full text-center py-3 border border-acid text-acid uppercase tracking-widest text-xs rounded-full hover:bg-acid/10 transition-all duration-300 font-semibold", children: "Join Waitlist" })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#apply", className: "w-full inline-block text-center py-3 border border-white/20 text-bone uppercase tracking-widest text-xs rounded-full hover:border-acid hover:text-acid hover:bg-acid/5 transition-all duration-300", children: "Request Details" }) })
      ] })
    ] }, s.title)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-20 reveal border border-white/10 bg-ink p-8 md:p-12 flex flex-col lg:flex-row items-center justify-between gap-10 relative overflow-hidden group", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 w-full lg:w-auto flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "flex flex-col sm:flex-row gap-3 w-full max-w-lg mx-auto lg:mx-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "email", placeholder: "Enter your email address", required: true, className: "bg-carbon border border-white/20 px-6 py-4 sm:py-3 rounded-full text-bone placeholder:text-bone/40 focus:outline-none focus:border-acid w-full sm:min-w-[280px] transition-colors text-sm" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", className: "bg-acid text-ink font-semibold uppercase tracking-widest text-xs px-8 py-4 sm:py-3 rounded-full hover:bg-bone transition-colors whitespace-nowrap", children: "Get Briefing PDF" })
      ] }) })
    ] })
  ] }) });
}
function Partnership({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative py-32 px-6 bg-carbon", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { kicker: "Partnership", title: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      "A New Model of ",
...
function BuildProcess({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "build", className: "relative py-32 px-6 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("video", { src: videoCarSection, autoPlay: true, muted: true, loop: true, playsInline: true, className: "absolute inset-0 h-full w-full object-cover opacity-15 pointer-events-none" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-7xl", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal-stagger grid md:grid-cols-2 lg:grid-cols-4 gap-8", children: process.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t-2 border-acid pt-6", children: [
...
function Events({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "events", className: "relative py-32 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { kicker: "Syndicate Community", title: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      "Upcoming Events & ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-8", children: events.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reveal border border-white/10 bg-carbon p-8 flex flex-col justify-between hover:border-acid transition-all duration-300", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 pt-6 border-t border-white/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#apply", className: "inline-flex items-center gap-2 text-xs uppercase tracking-widest text-acid hover:text-bone transition-colors", children: [
        "Request Invite ",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative py-32 px-6 overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-6xl", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6", children: [{
        ...
        t: "Exclusive Asset",
        b: "A one-of-one engineered car"
      }, {
        t: "Experiential",
        b: "Events, driving, access"
      }, {
        t: "Upside Potential",
        b: "On future sale"
...
function Apply() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "apply", className: "relative py-40 px-6 border-t border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-5xl text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:hello@syndicatedrestomod.com", className: "reveal inline-block px-12 py-5 bg-acid text-ink font-semibold uppercase tracking-widest rounded-full hover:bg-bone transition-colors", children: "Apply for Allocation" })
  ] }) });
}
function Index() {
  useReveal();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "bg-ink text-bone overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(BuildProcess, { process }),
